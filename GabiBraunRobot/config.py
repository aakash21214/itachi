...
class Config(object):
    ...
    TOKEN = "5785101195:AAHbWMBDku6q9tWJdMIJtJvhEl3ajmC0spQ"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    JOIN_LOGGER = -1001913986602  #Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = -1001913986602  #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit
